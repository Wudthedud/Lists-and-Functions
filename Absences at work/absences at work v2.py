...
# Printing results
print("\nResults:")
print(f"1. Average days of absences per year: {average:.2f} days")
print(f"2. Person with the most days of absences: {most_absent}")
print(f"3. People with zero absences: {', '.join(zero_absence)}")
print(f"4. People with absences above average: {', '.join(above_average)}")
